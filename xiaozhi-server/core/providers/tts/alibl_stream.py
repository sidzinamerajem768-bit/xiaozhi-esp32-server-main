...
class TTSProvider(TTSProviderBase):
    ...
    def _build_tts_parameters(self):
        params = {
            "text_type": "PlainText",
            "voice": self.voice,
            "format": self.format,
        ...
        if self.language_hints:
            params["language_hints"] = self.language_hints
        return params

    async def start_session(self, session_id):
        logger.bind(tag=TAG).info(f"[TTS-ALIBL] model={self.model} voice={self.voice} lang={self.language} lang_hints={self.language_hints}")
        try:
            ...
            run_task_message = {
                ...
                "payload": {
                    ...
                    "model": self.model,
                    "parameters": self._build_tts_parameters(),
                    "input": {}
                },
            }
